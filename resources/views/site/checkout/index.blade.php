...
@section('content')
    ...
    <div class="checkout_payment">
        <div class="iphone">
            ...
            <form action="{{route('checkout.add')}}" class="form" method="POST">
                @csrf
                <div>
                    <h2>Address</h2>
                    <div class="card">
                ...
                <fieldset>
                    ...
                    <div class="form__radios">
                        ...
                        <div class="form__radio">
                            <label for="momo"> <svg viewBox="6.7169296377637995 5.309796557160162 81.4130703622362 74.62020344283985"
                            ...
                            <input checked id="momo" value="1" name="payment_method" type="radio" />
                        </div>
                        <div class="form__radio">
                ...
                <div>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td>Price Total</td>
                                <td align="right" class="price_modal">{{ Helper::formatCurrency($price) }}</td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
                                <td>Total</td>
                                <td align="right" class="total_modal">{{ Helper::formatCurrency($total) }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
