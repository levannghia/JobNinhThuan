    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <table class="table table-hover" id="profileTable">
                ...
                <tbody>
                    @foreach ($hoSoXinViec_list as $key => $item)
                        <tr>
                            <th scope="row">{{ $key + 1 }}</th>
                            <td><a href="{{ route('seeker.profile.edit.profile', ['slug' => $item->slug, 'id' => $item->id]) }}"
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item"
                                                href="{{ route('seeker.profile.edit.profile', ['slug' => $item->slug, 'id' => $item->id]) }}">Chỉnh
                                                sửa</a></li>
                                        <li><a class="dropdown-item" href="#" data-name="{{$item->vi_tri}}" data-delete-id="{{ $item->id }}">Xóa</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#">Trang trí CV</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            ...
                            url: "{{ route('seeker.profile.delete.profile') }}",
                            contentType: false,
                            dataType: "json",
                            data: {
                                id: id,
